		...
		if(obj.ok === 3) {
			db.findOneById("shopTypeList", obj.params.shopTypeId, function(err, shopType) {
				...
				db.insertOne("shopList", {
					...
					shopStartDeliveryCost: obj.params.startDeliveryCost,
					shopDeliveryCost: obj.params.deliveryCost,
					shopMonthSaleCount: obj.params.monthSaleCount,
					shopPerCapita: obj.params.perCapita,
